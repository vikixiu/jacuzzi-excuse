    ...
    return {
        ...
        link: function(scope, element) {
            ...
            scrollbar.on('touchstart', function(event) {
                ...
                scrollbarOffset = ifVertElseHor(event.targetTouches[0].screenY, event.targetTouches[0].screenX);
            ...
            angular.element(document).on('touchmove', function(event) {
                ...
                var delta = ifVertElseHor(event.targetTouches[0].screenY, event.targetTouches[0].screenX) - scrollbarOffset;
                //delta *= config.dragSpeedModifier;
